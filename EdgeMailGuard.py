...
# ==========================================
# PART 3: THE MODERN DASHBOARD GUI (Unchanged Design)
# ==========================================
class ModernEdgeGuard:
    ...
    # The simulator itself can remain synchronous/threaded because it's just a test client
    ...
    def _run_simulation(self, type):
        try:
            import socket # Local import to avoid confusion
